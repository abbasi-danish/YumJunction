    ...
    return (
        <div className="recipe1">
            <div className="header" style={{ borderBottom: "3px solid black", width: "100%" }}>
                <h1>Adventure Time: Jake's Perfect Sandwich</h1>
            </div>
            <div style={{ float: "right" }}>
                <img src={perfectSandwich} alt="Jake's Perfect Sandwich" style={{ width: 700, height: "auto", border: "3px solid black", left:100 }} />
            </div>
            <h2>Ingredients</h2>
            <ul>
