...
test('renders team landing page', () => {
    ...
    const member2Element = screen.getByText(/Danish Abbasi is SpongeBob's best friend. He is known for his love of ice cream and his lack of intelligence./i);
   expect(member2Element).toBeInTheDocument();
    ...
    const member4Element = screen.getByText(/Fitz Gerald is the owner of the Krusty Krab. He is known for his love of money and his greed./i);
